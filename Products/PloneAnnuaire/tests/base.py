...
def setup_product():
    ...
    import Products.PloneAnnuaire
    zcml.load_config('configure.zcml', Products.PloneAnnuaire)
    ...
    ztc.installPackage('Products.PloneAnnuaire')
...
setup_product()
ptc.setupPloneSite(products=['Products.PloneAnnuaire'])
